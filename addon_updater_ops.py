...
def register(bl_info):
    ...
    # if updater.error != None:  TODO uncomment
    ...
    # 		enable=True,months=0,days=1,hours=0,minutes=0)
    ...
    updater.include_branch_list = ['development']  # None is the equivalent to setting ['master']
